<template>
	<view class="u-image" @tap="onClick" :style="[wrapStyle, backgroundStyle]">
		...
		<view v-if="showLoading && loading" class="u-image__loading" :style="{
			...
			<image style='width: 100%;height:100%' v-else src='https://manghe.jikechaowan.com/image/touming.png'></image>
			</image>
		</view>
...
<style scoped lang="scss">
	...
	.l0ading {
		width: 100%;
		height: 100%;
		background-image: url('https://manghe.jikechaowan.com/image/touming.png');
