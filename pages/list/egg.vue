<template>
  <view>
    ...
    <egg-item  :jifen_id="jifen_id" ref="mescrollItem" :type='type' v-if='id' :uid="id" v-for="(tab,i) in list" :key="i" :i="i" :index="tabIndex"
              :tabs="list"></egg-item>
...
import eggItem from './components/egg-item.vue'
