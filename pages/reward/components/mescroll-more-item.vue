<template>
  ...
  <mescroll-uni :ref="'mescrollRef'+i" @init="mescrollInit" :height="height" :down="downOption" @down="downCallback"
    ...
    <!-- 数据列表 -->
    <u-card margin='16rpx' :head-style="{padding:'20rpx'}" v-for="(item,index) in goods">
      <view class="head" slot='head'>
        <text style='color: #eb555b;font-size: 24rpx;'>待使用</text>
      </view>
      <view class="body" slot="body">
        <u-image style="flex-shrink: 0;margin: 0 20rpx;" width="180rpx" height="180rpx"
                 src="https://cdn.uviewui.com/uview/common/logo.png"></u-image>
        <view class="body-right">
          <text class="u-line-2" style="font-size: 24rpx;line-height: 1.2;">BANDAI万代MG 1/100飞翼零式改EW KA版卡版</text>
          <view class="tag">
            <text>回收价</text>
